...
import { ThemeColorMenuTrigger } from './ThemeColorMenuTrigger/ThemeColorMenuTrigger'
import styles from './ThemeColorMenu.module.css'

const ThemeColorMenuContent = dynamic(
  () =>
    import('./ThemeColorMenuContent/ThemeColorMenuContent').then(mod => mod.ThemeColorMenuContent),
  {
    ssr: false,
