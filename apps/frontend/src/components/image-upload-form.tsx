...
const FileSizeAlert = dynamic(
  () => import('./alerts/alert-file-size').then(mod => mod.AlertFileSize),
  {
    ssr: false
  }
)
const FileTypeAlert = dynamic(
  () => import('./alerts/alert-file-type').then(mod => mod.AlertFileType),
  {
    ssr: false
  }
)
const DefaultErrorAlert = dynamic(
  () => import('./alerts/alert-error-default').then(mod => mod.AlertErrorDefault),
  {
    ssr: false
  }
)
