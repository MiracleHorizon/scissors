...
const ExtendDirectionFormNumber = dynamic(
  () => import('./extend-direction-form-number').then(mod => mod.ExtendDirectionFormNumber),
  {
    ssr: false,
...
const ExtendDirectionFormAxis = dynamic(
  () => import('./extend-direction-form-axis').then(mod => mod.ExtendDirectionFormAxis),
  {
    ssr: false,
    loading: () => (
      <>
...
const ExtendDirectionFormSeparated = dynamic(
  () => import('./extend-direction-form-separated').then(mod => mod.ExtendDirectionFormSeparated),
  {
    ssr: false,
    loading: () => (
      <>
