...
import { MetadataCheckboxGroup } from './metadata-checkbox-group'
import { CalloutDefault } from '@ui/callout-default'
...
const MetadataTablesAccordion = dynamic(
  () => import('./metadata-tables-accordion').then(mod => mod.MetadataTablesAccordion),
  {
    ssr: false
  }
)
